...
class Controls extends FlxActionSet
{
	...
	public function loadKeyBinds()
	{
		...
		inline bindKeys(Control.L1, [FlxKey.fromString(FlxG.save.data.l1Bind), FlxKey.S]);
		inline bindKeys(Control.U1, [FlxKey.fromString(FlxG.save.data.uBind), FlxKey.D]);
		inline bindKeys(Control.R1, [FlxKey.fromString(FlxG.save.data.r1Bind), FlxKey.F]);
		inline bindKeys(Control.L2, [FlxKey.fromString(FlxG.save.data.l2Bind), FlxKey.J]);
		inline bindKeys(Control.D1, [FlxKey.fromString(FlxG.save.data.dBind), FlxKey.K]);
		inline bindKeys(Control.R2, [FlxKey.fromString(FlxG.save.data.r2Bind), FlxKey.L]);

		inline bindKeys(Control.N0, [FlxKey.fromString(FlxG.save.data.n0Bind), FlxKey.A]);
		inline bindKeys(Control.N1, [FlxKey.fromString(FlxG.save.data.n1Bind), FlxKey.S]);
		inline bindKeys(Control.N2, [FlxKey.fromString(FlxG.save.data.n2Bind), FlxKey.D]);
		inline bindKeys(Control.N3, [FlxKey.fromString(FlxG.save.data.n3Bind), FlxKey.F]);
		inline bindKeys(Control.N4, [FlxKey.fromString(FlxG.save.data.n4Bind), FlxKey.SPACE]);
		inline bindKeys(Control.N5, [FlxKey.fromString(FlxG.save.data.n5Bind), FlxKey.H]);
		inline bindKeys(Control.N6, [FlxKey.fromString(FlxG.save.data.n6Bind), FlxKey.J]);
		inline bindKeys(Control.N7, [FlxKey.fromString(FlxG.save.data.n7Bind), FlxKey.K]);
		inline bindKeys(Control.N8, [FlxKey.fromString(FlxG.save.data.n8Bind), FlxKey.L]);
